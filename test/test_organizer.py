...
def test_organizer_dry_run_system():
    with TemporaryDirectory() as src_dir, TemporaryDirectory() as dst_dir:
        ...
        result = runner.invoke(eagleliz_app, ["organizer", src_dir, dst_dir, "--dry"], input="\n")
...
def test_organizer_eagle_catalog_dry():
    ...
    with TemporaryDirectory() as dst_dir:
        result = runner.invoke(eagleliz_app, ["organizer", str(TEST_CATALOG_PATH), dst_dir, "--eaglecatalog", "--dry"], input="\n")
...
def test_organizer_exclude_dry():
    with TemporaryDirectory() as src_dir, TemporaryDirectory() as dst_dir:
        ...
        result = runner.invoke(eagleliz_app, ["organizer", src_dir, dst_dir, "--dry", "--exclude", "exclude_me"], input="\n")
